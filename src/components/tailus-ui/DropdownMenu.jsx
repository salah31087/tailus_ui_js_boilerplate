...
const DropdownMenuContent = React.forwardRef(({ className, variant, intent, mixed, fancy, ...props }, forwardedRef) => {
...
const DropdownMenuItem = React.forwardRef(({ className, variant, intent, ...props }, forwardedRef) => {
...
const DropdownMenuSeparator = React.forwardRef(({ className, fancy, ...props }, forwardedRef) => {
...
const DropdownMenuSubTrigger = React.forwardRef(({ className, variant, intent, ...props }, forwardedRef) => {
...
const DropdownMenuSubContent = React.forwardRef(({ className, variant, intent, fancy, mixed, ...props }, forwardedRef) => {
...
const DropdownMenuIcon = ({className, children}) => {
...
const DropdownMenuRightIcon = React.forwardRef(({className, ...props}, forwardedRef) => {
